...
function AnalisisImpacto(props) {
    ...
    return (
        <React.Fragment>
            ...
            <Link to={`/propuestaCambio/${requerimiento.id_subProyecto}`} style={{position:'absolute', left:'2%', top:'88px'}}><button type="button" className="btn boton"><ArrowBackIcon/></button></Link>
